 ...
 * (decided 2026-06-12: Option B layout + Form 2 distribution; see
 * rn-header-transition-overview.md "DECISION" and the spike evidence there).
 *
 * One source of truth, three consumers:
 *   1. the prebuild compose step / zero-i-repackage EMITS artifacts from it,
 *   2. the contract verifier (Gate A) CHECKS artifacts against it,
 *   3. the SPM tooling derives what consumers need (nothing, by design).
 *
 * The rules (each verified by compile evidence in the spikes):
 *
